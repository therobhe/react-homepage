    ...
    return (
        <main className="wrapper container">
            ...
            <section id="contact-section" className="contact-section section">
                ...
                <div className="intro">
                    <img className="profile-image img-rounded" src="img/me.jpg" width="720" height="720" alt="Robert Heinemann" />
                    <div className="dialog">
                        <p>Contact me per E-Mail: <a href = "mailto:rheinemann97@t-online.de">rheinemann97@t-online.de</a></p>
                        <p>or via:</p>
